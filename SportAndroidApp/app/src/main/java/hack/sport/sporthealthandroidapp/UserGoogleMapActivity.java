...
import hack.sport.sporthealthandroidapp.models.Person;

/**
 * Demonstrates heavy customisation of the look of rendered clusters.
 */
public class UserGoogleMapActivity extends MapsActivity implements ClusterManager.OnClusterClickListener<Person>, ClusterManager.OnClusterInfoWindowClickListener<Person>, ClusterManager.OnClusterItemClickListener<Person>, ClusterManager.OnClusterItemInfoWindowClickListener<Person> {
    ...
    private class PersonRenderer extends DefaultClusterRenderer<Person> {
        ...
        public PersonRenderer(GoogleMap maps) {
            super(getApplicationContext(), maps, mClusterManager);
    ...
    public boolean onClusterItemClick(Person item) {
        ...
        LatLng endPoint = new LatLng(37.423, -122.091);
        LatLng startPoint = new LatLng(-33.866, 151.195);

        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                startPoint, 13));

        // Polylines are useful for marking paths and routes on the map.
        googleMap.addPolyline(new PolylineOptions().geodesic(true).width(5)
                .add(startPoint)  // Sydney
    ...
    protected void startDemo(GoogleMap mMap) {
        ...
        mClusterManager.setRenderer(new PersonRenderer(mMap));
