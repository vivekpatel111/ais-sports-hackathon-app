...
import hack.sport.sporthealthandroidapp.utils.QuickstartPreferences;
import hack.sport.sporthealthandroidapp.utils.RegistrationIntentService;
...
public class Dashboard extends AppCompatActivity
    ...
    private void setData(int count, float range) {
        ...
        set1.setColor(Color.parseColor("#4886BB"));
