...
import hack.sport.sporthealthandroidapp.Dashboard;
...
public class MyGcmListenerService extends GcmListenerService {
    ...
    private void sendNotification(Bundle data) {
        ...
        Uri notifSound;
        if( data.getString("gcm.notification.sound2").equalsIgnoreCase("default")){
            notifSound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        }else {
            notifSound = Uri.parse("android.resource://hack.sport.sporthealthandroidapp/raw/" + data.getString("gcm.notification.sound2"));
        }
